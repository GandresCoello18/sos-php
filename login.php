                ...
                if($stmt->rowCount() == 1){
                    if($row = $stmt->fetch()){
                        ...
                        if(password_verify($password, $hashed_password)){
                            ...
                            $password_err = "El password ingresado no es válido.";
                        }
                    }
                } else{
...
<body class="text-center">
        ...
        <form class="form-signin" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <h1 class="h3 mb-3 font-weight-normal">Emergencias</h1>
            ...
            <p class="mt-5 mb-3 text-muted">Universidad Técnica de Babahoyo</p>
        </form>
